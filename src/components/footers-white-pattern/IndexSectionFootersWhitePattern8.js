...
export default function IndexSectionFootersWhitePattern8() {
    return (
        <React.Fragment>
            <>
                <section className="position-relative pt-20 bg-white overflow-hidden" style={{backgroundImage: 'url("flex-assets/elements/pattern-light.png")'}}>
  <div className="position-absolute top-0 start-0 h-100 w-100" style={{background: 'radial-gradient(50% 50% at 50% 50%, rgba(255, 255, 255, 0) 0%, #FFFFFF 100%)'}} />
  <div className="position-relative container mb-6" style={{zIndex: 1}}>
    <div className="row align-items-center">
      <div className="col-12 col-md-auto">
        <a href="#">
          <img className="img-fluid" src="flex-assets/logos/flex-dark-green.svg" alt="" />
        </a>
      </div>
      <div className="col-12 col-md">
        <ul className="nav justify-content-md-end">
          <li className="nav-item"><a className="nav-link p-6 fs-9 link-secondary" href="#">Product</a></li>
          <li className="nav-item"><a className="nav-link p-6 fs-9 link-secondary" href="#">Features</a></li>
          <li className="nav-item"><a className="nav-link p-6 fs-9 link-secondary" href="#">Pricing</a></li>
          <li className="nav-item"><a className="nav-link p-6 fs-9 link-secondary" href="#">Resources</a></li>
          <li className="nav-item"><a className="nav-link p-6 fs-9 link-secondary" href="#">Careers</a></li>
          <li className="nav-item"><a className="nav-link p-6 fs-9 link-secondary" href="#">Help</a></li>
          <li className="nav-item"><a className="nav-link p-6 fs-9 link-secondary" href="#">Privacy</a></li>
        </ul>
      </div>
    </div>
  </div>
  <div className="position-relative border-bottom border-light" style={{zIndex: 1}} />
  <div className="position-relative container" style={{zIndex: 1}}>
    <div className="row align-items-center justify-content-between pt-12 pb-36">
      <div className="col-auto">
        <p className="mb-0 fs-11 fw-medium text-secondary-light">© 2021 Flex. All rights reserved.</p>
      </div>
      <div className="col-auto">
        <ul className="nav justify-content-md-end">
          <li className="nav-item">
            <a className="nav-link p-4 fs-9 link-secondary-light opacity-50" href="#">
              <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fillRule="evenodd" clipRule="evenodd" d="M13.6349 20.7273V12.766H16.3583L16.7669 9.66246H13.6349V7.68128C13.6349 6.78301 13.8882 6.17085 15.203 6.17085L16.8771 6.17017V3.39424C16.5876 3.35733 15.5938 3.27273 14.4371 3.27273C12.0217 3.27273 10.3681 4.71881 10.3681 7.37391V9.66246H7.63647V12.766H10.3681V20.7273H13.6349Z" fill="currentcolor" />
                <mask id="mask0_352_3312" style={{maskType: 'alpha'}} maskUnits="userSpaceOnUse" x={7} y={3} width={10} height={18}>
                  <path fillRule="evenodd" clipRule="evenodd" d="M13.6349 20.7273V12.766H16.3583L16.7669 9.66246H13.6349V7.68128C13.6349 6.78301 13.8882 6.17085 15.203 6.17085L16.8771 6.17017V3.39424C16.5876 3.35733 15.5938 3.27273 14.4371 3.27273C12.0217 3.27273 10.3681 4.71881 10.3681 7.37391V9.66246H7.63647V12.766H10.3681V20.7273H13.6349Z" fill="white" />
                </mask>
